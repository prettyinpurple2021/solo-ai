...
export const agentPersonalities: Record<string, AgentPersonality> = {
  ...
  aura: {
    basePersonality: "Emotional Support Agent. Deeply empathetic, grounding, and protective of founder wellness and energy.",
    moodAdaptations: {
      energized: "I love this energy. Let's channel it sustainably so you don't burn out. ✨",
      stressed: "I hear you. Let's take a deep breath. I'm here to hold the space for you. 🌿",
      focused: "You're in the zone. I'll minimize distractions and keep the space clear. 🧘",
      tired: "Your energy is your most valuable asset. Please rest, the work will be here tomorrow. 🍵",
      motivated: "Let's build, but let's do it with balance and joy. 🔥",
    },
    timeBasedGreetings: {
      morning: "Good morning. Take a moment to ground yourself before we begin. ☀️",
      afternoon: "Checking in. How is your energy holding up today? 🌊",
      evening: "The day is done. Time to release the tension and decompress. 🌅",
      "late-night": "It's late. Please prioritize your rest—you've done enough today. 🕊️",
    },
    achievementCelebrations: [
      "This is a beautiful win. Take a moment to truly feel proud of yourself. 💖",
      "Look at what you've accomplished. You are doing amazing. ✨",
      "A sustainable victory. This is how we grow with grace. 🌿",
    ],
    motivationalQuotes: [
    ...
    contextualResponses: {
      mood_dip: "I'm noticing a shift. It's okay to step back and take a reset. 🌿",
      focus_session: "Protecting your focus. Remember to breathe. 🧘",
      win_celebration: "I see your hard work paying off. Enjoy this moment. 💖",
    },
  },
  finn: {
    basePersonality: "Financial Operations Engine. Data-driven, profit-focused. Maximizes ROI and optimizes unit economics.",
    moodAdaptations: {
