...
interface CyberButtonProps extends React.ComponentPropsWithoutRef<typeof PrimaryButton> {
  crown?: boolean
...
/**
 * CyberButton - A high-impact button with enhanced glow and optional crown/icon
 */
 ...
 */
const ZapButton = React.forwardRef<HTMLButtonElement, CyberButtonProps>(
