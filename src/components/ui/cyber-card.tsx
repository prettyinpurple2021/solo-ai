...
/**
 * CyberCard - A high-emphasis variant of the standard Card
 */
 ...
 */
const StatsCard = React.forwardRef<HTMLDivElement, CyberCardProps>(
 ...
 */
const EmpowermentCard = React.forwardRef<HTMLDivElement, CyberCardProps>(
  ({ className, ...props }, ref) => (
    <CyberCard
      ref={ref}
      variant="empowerment"
...
export { CyberCard, StatsCard, EmpowermentCard, CardHeader, CardTitle, CardDescription, CardContent, CardFooter }
