...
| Variable |
|----------|
| `SMTP_HOST`, `SMTP_PORT`, `SMTP_SECURE`, `SMTP_USER`, `SMTP_PASSWORD`, `FROM_EMAIL`, `CONTACT_INBOX_EMAIL` (see [ZOHO_MAIL_SMTP_SETUP.md](./ZOHO_MAIL_SMTP_SETUP.md)) |
...
| `INTERNAL_API_KEY`, `INTERNAL_AGENT_SECRET`, `ENCRYPTION_KEY`, `ENABLE_ADMIN_BYPASS`, `ADMIN_USER_IDS`, `ADMIN_EMAILS`, `BRAVE_API_KEY`, `NOTIFICATION_JOB_TOKEN` |
