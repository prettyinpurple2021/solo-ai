...
CREATE TABLE "slides" (
	...
	"order" integer NOT NULL,
	"layout" varchar(50) DEFAULT 'blank',
	"title" varchar(255),
...
ALTER TABLE "admin_actions" DROP CONSTRAINT "admin_actions_admin_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "agent_instructions" DROP CONSTRAINT "agent_instructions_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "board_reports" DROP CONSTRAINT "board_reports_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "campaigns" DROP CONSTRAINT "campaigns_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "code_snippets" DROP CONSTRAINT "code_snippets_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "contacts" DROP CONSTRAINT "contacts_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "creative_assets" DROP CONSTRAINT "creative_assets_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "daily_intelligence" DROP CONSTRAINT "daily_intelligence_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "interview_guides" DROP CONSTRAINT "interview_guides_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "job_descriptions" DROP CONSTRAINT "job_descriptions_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "launch_strategies" DROP CONSTRAINT "launch_strategies_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "legal_docs" DROP CONSTRAINT "legal_docs_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "notification_preferences" DROP CONSTRAINT "notification_preferences_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "notifications" DROP CONSTRAINT "notifications_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "pivot_analyses" DROP CONSTRAINT "pivot_analyses_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "product_specs" DROP CONSTRAINT "product_specs_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "simulations" DROP CONSTRAINT "simulations_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "sops" DROP CONSTRAINT "sops_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "subscriptions" DROP CONSTRAINT "subscriptions_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "training_history" DROP CONSTRAINT "training_history_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "tribe_blueprints" DROP CONSTRAINT "tribe_blueprints_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "usage_tracking" DROP CONSTRAINT "usage_tracking_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "war_room_sessions" DROP CONSTRAINT "war_room_sessions_user_id_users_id_fk";
--> statement-breakpoint
...
ALTER TABLE "agent_instructions" ALTER COLUMN "id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "agent_instructions" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "board_reports" ALTER COLUMN "id" SET DATA TYPE serial;--> statement-breakpoint
ALTER TABLE "board_reports" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "business_context" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "campaigns" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "chat_history" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "chat_history" ALTER COLUMN "timestamp" SET DATA TYPE bigint;--> statement-breakpoint
ALTER TABLE "code_snippets" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "code_snippets" ALTER COLUMN "title" SET DATA TYPE varchar(255);--> statement-breakpoint
ALTER TABLE "code_snippets" ALTER COLUMN "title" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "code_snippets" ALTER COLUMN "language" SET DATA TYPE varchar(50);--> statement-breakpoint
ALTER TABLE "code_snippets" ALTER COLUMN "language" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "code_snippets" ALTER COLUMN "code" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "competitor_reports" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
...
ALTER TABLE "creative_assets" ALTER COLUMN "type" SET DATA TYPE varchar(50);--> statement-breakpoint
ALTER TABLE "creative_assets" ALTER COLUMN "title" SET DATA TYPE varchar(255);--> statement-breakpoint
ALTER TABLE "creative_assets" ALTER COLUMN "title" SET NOT NULL;--> statement-breakpoint
...
ALTER TABLE "interview_guides" ALTER COLUMN "questions" SET DEFAULT '[]'::jsonb;--> statement-breakpoint
ALTER TABLE "interview_guides" ALTER COLUMN "questions" DROP NOT NULL;--> statement-breakpoint
...
ALTER TABLE "launch_strategies" ALTER COLUMN "phases" SET DEFAULT '[]'::jsonb;--> statement-breakpoint
ALTER TABLE "legal_docs" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "legal_docs" ALTER COLUMN "title" SET DATA TYPE varchar(255);--> statement-breakpoint
ALTER TABLE "legal_docs" ALTER COLUMN "type" SET DATA TYPE varchar(50);--> statement-breakpoint
ALTER TABLE "legal_docs" ALTER COLUMN "content" DROP NOT NULL;--> statement-breakpoint
/* 
...
-- ALTER TABLE "notification_preferences" DROP CONSTRAINT "<constraint_name>";--> statement-breakpoint
ALTER TABLE "notification_preferences" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "notification_preferences" ALTER COLUMN "digest_time" SET DATA TYPE varchar(10);--> statement-breakpoint
ALTER TABLE "notification_preferences" ALTER COLUMN "digest_time" SET DEFAULT '08:00';--> statement-breakpoint
...
ALTER TABLE "notifications" ALTER COLUMN "category" SET DATA TYPE varchar(50);--> statement-breakpoint
...
ALTER TABLE "notifications" ALTER COLUMN "priority" SET DEFAULT 'medium';--> statement-breakpoint
...
ALTER TABLE "pitch_decks" ALTER COLUMN "title" SET DATA TYPE varchar(255);--> statement-breakpoint
...
ALTER TABLE "search_index" ALTER COLUMN "id" SET DATA TYPE integer;--> statement-breakpoint
ALTER TABLE "search_index" ALTER COLUMN "id" ADD GENERATED ALWAYS AS IDENTITY (sequence name "search_index_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1);--> statement-breakpoint
ALTER TABLE "search_index" ALTER COLUMN "entity_type" SET DATA TYPE varchar(50);--> statement-breakpoint
ALTER TABLE "search_index" ALTER COLUMN "title" SET DATA TYPE varchar(255);--> statement-breakpoint
ALTER TABLE "search_index" ALTER COLUMN "tags" SET DATA TYPE jsonb;--> statement-breakpoint
ALTER TABLE "search_index" ALTER COLUMN "tags" SET DEFAULT '[]'::jsonb;--> statement-breakpoint
...
ALTER TABLE "subscriptions" ALTER COLUMN "tier" SET DATA TYPE varchar(50);--> statement-breakpoint
ALTER TABLE "subscriptions" ALTER COLUMN "tier" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "subscriptions" ALTER COLUMN "status" SET DATA TYPE varchar(50);--> statement-breakpoint
ALTER TABLE "subscriptions" ALTER COLUMN "status" DROP NOT NULL;--> statement-breakpoint
...
ALTER TABLE "training_history" ALTER COLUMN "id" SET DATA TYPE text;--> statement-breakpoint
...
ALTER TABLE "usage_tracking" ALTER COLUMN "month" SET DATA TYPE varchar(7);--> statement-breakpoint
ALTER TABLE "usage_tracking" ALTER COLUMN "business_profiles" SET DEFAULT 0;--> statement-breakpoint
ALTER TABLE "users" ALTER COLUMN "id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "users" ALTER COLUMN "email" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ALTER COLUMN "role" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "war_room_sessions" ALTER COLUMN "id" SET DATA TYPE serial;--> statement-breakpoint
ALTER TABLE "war_room_sessions" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "war_room_sessions" ALTER COLUMN "topic" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "war_room_sessions" ALTER COLUMN "dialogue" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "war_room_sessions" ALTER COLUMN "action_plan" SET DATA TYPE jsonb;--> statement-breakpoint
ALTER TABLE "agent_instructions" ADD COLUMN "agent_role" varchar(50) NOT NULL;--> statement-breakpoint
ALTER TABLE "agent_instructions" ADD COLUMN "instructions" text NOT NULL;--> statement-breakpoint
ALTER TABLE "agent_instructions" ADD COLUMN "is_active" boolean DEFAULT true;--> statement-breakpoint
ALTER TABLE "agent_instructions" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "business_context" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "campaigns" ADD COLUMN "name" varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE "campaigns" ADD COLUMN "status" varchar(50) DEFAULT 'planned';--> statement-breakpoint
ALTER TABLE "campaigns" ADD COLUMN "channels" jsonb DEFAULT '[]'::jsonb;--> statement-breakpoint
ALTER TABLE "campaigns" ADD COLUMN "budget" integer;--> statement-breakpoint
ALTER TABLE "campaigns" ADD COLUMN "start_date" timestamp;--> statement-breakpoint
ALTER TABLE "campaigns" ADD COLUMN "end_date" timestamp;--> statement-breakpoint
ALTER TABLE "campaigns" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "campaigns" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "code_snippets" ADD COLUMN "description" text;--> statement-breakpoint
ALTER TABLE "code_snippets" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "code_snippets" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "competitor_reports" ADD COLUMN "mission_brief" text;--> statement-breakpoint
ALTER TABLE "competitor_reports" ADD COLUMN "intel" jsonb;--> statement-breakpoint
ALTER TABLE "competitor_reports" ADD COLUMN "vulnerabilities" jsonb;--> statement-breakpoint
ALTER TABLE "competitor_reports" ADD COLUMN "strengths" jsonb;--> statement-breakpoint
ALTER TABLE "competitor_reports" ADD COLUMN "metrics" jsonb;--> statement-breakpoint
ALTER TABLE "creative_assets" ADD COLUMN "url" varchar(1000);--> statement-breakpoint
ALTER TABLE "creative_assets" ADD COLUMN "campaign_id" text;--> statement-breakpoint
ALTER TABLE "creative_assets" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "creative_assets" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "daily_intelligence" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "interview_guides" ADD COLUMN "title" varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE "interview_guides" ADD COLUMN "role" varchar(100);--> statement-breakpoint
ALTER TABLE "interview_guides" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "interview_guides" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "job_descriptions" ADD COLUMN "title" varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE "job_descriptions" ADD COLUMN "role" varchar(100);--> statement-breakpoint
ALTER TABLE "job_descriptions" ADD COLUMN "department" varchar(100);--> statement-breakpoint
ALTER TABLE "job_descriptions" ADD COLUMN "content" text;--> statement-breakpoint
ALTER TABLE "job_descriptions" ADD COLUMN "status" varchar(50) DEFAULT 'draft';--> statement-breakpoint
ALTER TABLE "job_descriptions" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "job_descriptions" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "launch_strategies" ADD COLUMN "title" varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE "launch_strategies" ADD COLUMN "status" varchar(50) DEFAULT 'draft';--> statement-breakpoint
ALTER TABLE "launch_strategies" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "launch_strategies" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "legal_docs" ADD COLUMN "status" varchar(50) DEFAULT 'draft';--> statement-breakpoint
ALTER TABLE "legal_docs" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "legal_docs" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "notification_preferences" ADD COLUMN "id" integer PRIMARY KEY NOT NULL GENERATED ALWAYS AS IDENTITY (sequence name "notification_preferences_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1);--> statement-breakpoint
ALTER TABLE "pitch_decks" ADD COLUMN "description" text;--> statement-breakpoint
ALTER TABLE "pitch_decks" ADD COLUMN "theme" varchar(50) DEFAULT 'modern';--> statement-breakpoint
ALTER TABLE "pitch_decks" ADD COLUMN "thumbnail" varchar(1000);--> statement-breakpoint
ALTER TABLE "pitch_decks" ADD COLUMN "is_public" boolean DEFAULT false;--> statement-breakpoint
ALTER TABLE "pitch_decks" ADD COLUMN "is_template" boolean DEFAULT false;--> statement-breakpoint
ALTER TABLE "pitch_decks" ADD COLUMN "version" integer DEFAULT 1;--> statement-breakpoint
ALTER TABLE "pitch_decks" ADD COLUMN "status" varchar(50) DEFAULT 'draft';--> statement-breakpoint
ALTER TABLE "pitch_decks" ADD COLUMN "view_count" integer DEFAULT 0;--> statement-breakpoint
ALTER TABLE "pitch_decks" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "product_specs" ADD COLUMN "title" varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE "product_specs" ADD COLUMN "version" varchar(50);--> statement-breakpoint
ALTER TABLE "product_specs" ADD COLUMN "status" varchar(50) DEFAULT 'draft';--> statement-breakpoint
ALTER TABLE "product_specs" ADD COLUMN "content" jsonb DEFAULT '{}'::jsonb;--> statement-breakpoint
ALTER TABLE "product_specs" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "product_specs" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "search_index" ADD COLUMN "metadata" jsonb DEFAULT '{}'::jsonb;--> statement-breakpoint
ALTER TABLE "search_index" ADD COLUMN "embedding" vector(1536);--> statement-breakpoint
ALTER TABLE "simulations" ADD COLUMN "title" varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE "simulations" ADD COLUMN "type" varchar(50);--> statement-breakpoint
ALTER TABLE "simulations" ADD COLUMN "parameters" jsonb DEFAULT '{}'::jsonb;--> statement-breakpoint
ALTER TABLE "simulations" ADD COLUMN "results" jsonb DEFAULT '{}'::jsonb;--> statement-breakpoint
ALTER TABLE "simulations" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "simulations" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "sops" ADD COLUMN "title" varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE "sops" ADD COLUMN "content" text;--> statement-breakpoint
ALTER TABLE "sops" ADD COLUMN "department" varchar(100);--> statement-breakpoint
ALTER TABLE "sops" ADD COLUMN "status" varchar(50) DEFAULT 'draft';--> statement-breakpoint
ALTER TABLE "sops" ADD COLUMN "version" integer DEFAULT 1;--> statement-breakpoint
ALTER TABLE "sops" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "sops" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
...
ALTER TABLE "training_history" ADD COLUMN "module_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "training_history" ADD COLUMN "completed_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "training_history" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "tribe_blueprints" ADD COLUMN "name" varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE "tribe_blueprints" ADD COLUMN "description" text;--> statement-breakpoint
ALTER TABLE "tribe_blueprints" ADD COLUMN "members" jsonb DEFAULT '[]'::jsonb;--> statement-breakpoint
ALTER TABLE "tribe_blueprints" ADD COLUMN "roles" jsonb DEFAULT '[]'::jsonb;--> statement-breakpoint
ALTER TABLE "tribe_blueprints" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "tribe_blueprints" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "usage_tracking" ADD COLUMN "updated_at" timestamp DEFAULT now();--> statement-breakpoint
...
ALTER TABLE "competitor_news_articles" ADD CONSTRAINT "competitor_news_articles_competitor_id_fk" FOREIGN KEY ("competitor_id") REFERENCES "public"."competitor_profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "competitor_social_mentions" ADD CONSTRAINT "competitor_social_mentions_competitor_id_fk" FOREIGN KEY ("competitor_id") REFERENCES "public"."competitor_profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "boardroom_messages_session_id_idx" ON "boardroom_messages" USING btree ("session_id" text_ops);--> statement-breakpoint
CREATE INDEX "boardroom_messages_created_at_idx" ON "boardroom_messages" USING btree ("created_at" timestamp_ops);--> statement-breakpoint
CREATE INDEX "boardroom_sessions_user_id_idx" ON "boardroom_sessions" USING btree ("user_id" text_ops);--> statement-breakpoint
CREATE INDEX "briefcase_items_briefcase_id_idx" ON "briefcase_items" USING btree ("briefcase_id" text_ops);--> statement-breakpoint
CREATE INDEX "briefcase_items_user_id_idx" ON "briefcase_items" USING btree ("user_id" text_ops);--> statement-breakpoint
CREATE INDEX "briefcase_items_type_idx" ON "briefcase_items" USING btree ("type" text_ops);--> statement-breakpoint
CREATE INDEX "briefcase_items_tags_idx" ON "briefcase_items" USING gin ("tags");--> statement-breakpoint
...
CREATE INDEX "competitor_news_articles_competitor_id_idx" ON "competitor_news_articles" USING btree ("competitor_id" text_ops);--> statement-breakpoint
CREATE INDEX "competitor_news_articles_published_at_idx" ON "competitor_news_articles" USING btree ("published_at" timestamp_ops);--> statement-breakpoint
CREATE INDEX "competitor_news_articles_category_idx" ON "competitor_news_articles" USING btree ("category" text_ops);--> statement-breakpoint
...
CREATE INDEX "competitor_social_mentions_competitor_id_idx" ON "competitor_social_mentions" USING btree ("competitor_id" text_ops);--> statement-breakpoint
CREATE INDEX "competitor_social_mentions_platform_idx" ON "competitor_social_mentions" USING btree ("platform" text_ops);--> statement-breakpoint
CREATE INDEX "competitor_social_mentions_published_at_idx" ON "competitor_social_mentions" USING btree ("published_at" timestamp_ops);--> statement-breakpoint
...
CREATE INDEX "market_intelligence_cache_expires_at_idx" ON "market_intelligence_cache" USING btree ("expires_at" timestamp_ops);--> statement-breakpoint
CREATE INDEX "market_intelligence_cache_source_idx" ON "market_intelligence_cache" USING btree ("source" text_ops);--> statement-breakpoint
...
CREATE INDEX "post_reactions_user_id_idx" ON "post_reactions" USING btree ("user_id" text_ops);--> statement-breakpoint
...
CREATE INDEX "slide_components_slide_id_idx" ON "slide_components" USING btree ("slide_id" text_ops);--> statement-breakpoint
CREATE INDEX "slides_deck_id_idx" ON "slides" USING btree ("deck_id" text_ops);--> statement-breakpoint
CREATE INDEX "slides_deck_order_idx" ON "slides" USING btree ("deck_id" text_ops,"order" int4_ops);--> statement-breakpoint
...
CREATE INDEX "user_briefcases_user_id_idx" ON "user_briefcases" USING btree ("user_id" text_ops);--> statement-breakpoint
CREATE INDEX "user_briefcases_default_idx" ON "user_briefcases" USING btree ("user_id" text_ops,"is_default" bool_ops);--> statement-breakpoint
...
CREATE INDEX "chat_history_user_agent_idx" ON "chat_history" USING btree ("user_id","agent_id");--> statement-breakpoint
CREATE INDEX "pitch_decks_user_id_idx" ON "pitch_decks" USING btree ("user_id" text_ops);--> statement-breakpoint
ALTER TABLE "agent_instructions" DROP COLUMN "agent_id";--> statement-breakpoint
ALTER TABLE "agent_instructions" DROP COLUMN "instruction";--> statement-breakpoint
ALTER TABLE "board_reports" DROP COLUMN "date";--> statement-breakpoint
ALTER TABLE "campaigns" DROP COLUMN "source_title";--> statement-breakpoint
ALTER TABLE "campaigns" DROP COLUMN "twitter_thread";--> statement-breakpoint
ALTER TABLE "campaigns" DROP COLUMN "linkedin_post";--> statement-breakpoint
ALTER TABLE "campaigns" DROP COLUMN "tiktok_script";--> statement-breakpoint
ALTER TABLE "campaigns" DROP COLUMN "newsletter_section";--> statement-breakpoint
ALTER TABLE "campaigns" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "code_snippets" DROP COLUMN "explanation";--> statement-breakpoint
ALTER TABLE "code_snippets" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "competitor_reports" DROP COLUMN "data";--> statement-breakpoint
ALTER TABLE "creative_assets" DROP COLUMN "content";--> statement-breakpoint
ALTER TABLE "creative_assets" DROP COLUMN "prompt";--> statement-breakpoint
ALTER TABLE "creative_assets" DROP COLUMN "style";--> statement-breakpoint
ALTER TABLE "creative_assets" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "daily_intelligence" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "interview_guides" DROP COLUMN "role_title";--> statement-breakpoint
ALTER TABLE "interview_guides" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "job_descriptions" DROP COLUMN "role_title";--> statement-breakpoint
ALTER TABLE "job_descriptions" DROP COLUMN "hook";--> statement-breakpoint
ALTER TABLE "job_descriptions" DROP COLUMN "responsibilities";--> statement-breakpoint
ALTER TABLE "job_descriptions" DROP COLUMN "requirements";--> statement-breakpoint
ALTER TABLE "job_descriptions" DROP COLUMN "perks";--> statement-breakpoint
ALTER TABLE "job_descriptions" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "launch_strategies" DROP COLUMN "product_name";--> statement-breakpoint
ALTER TABLE "launch_strategies" DROP COLUMN "launch_date";--> statement-breakpoint
ALTER TABLE "launch_strategies" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "legal_docs" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "pitch_decks" DROP COLUMN "slides";--> statement-breakpoint
ALTER TABLE "pitch_decks" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "pivot_analyses" DROP COLUMN "current_industry";--> statement-breakpoint
ALTER TABLE "product_specs" DROP COLUMN "feature_name";--> statement-breakpoint
ALTER TABLE "product_specs" DROP COLUMN "summary";--> statement-breakpoint
ALTER TABLE "product_specs" DROP COLUMN "features";--> statement-breakpoint
ALTER TABLE "product_specs" DROP COLUMN "data_model";--> statement-breakpoint
ALTER TABLE "product_specs" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "query";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "likely_case";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "best_case";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "worst_case";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "strategic_advice";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "timestamp";--> statement-breakpoint
ALTER TABLE "sops" DROP COLUMN "task_name";--> statement-breakpoint
ALTER TABLE "sops" DROP COLUMN "goal";--> statement-breakpoint
ALTER TABLE "sops" DROP COLUMN "steps";--> statement-breakpoint
ALTER TABLE "sops" DROP COLUMN "definition_of_done";--> statement-breakpoint
ALTER TABLE "sops" DROP COLUMN "generated_at";--> statement-breakpoint
...
ALTER TABLE "tasks" DROP COLUMN "estimated_time";--> statement-breakpoint
ALTER TABLE "training_history" DROP COLUMN "scenario_title";--> statement-breakpoint
ALTER TABLE "training_history" DROP COLUMN "strengths";--> statement-breakpoint
ALTER TABLE "training_history" DROP COLUMN "weaknesses";--> statement-breakpoint
ALTER TABLE "training_history" DROP COLUMN "pro_tip";--> statement-breakpoint
ALTER TABLE "training_history" DROP COLUMN "timestamp";--> statement-breakpoint
ALTER TABLE "tribe_blueprints" DROP COLUMN "manifesto";--> statement-breakpoint
ALTER TABLE "tribe_blueprints" DROP COLUMN "rituals";--> statement-breakpoint
ALTER TABLE "tribe_blueprints" DROP COLUMN "engagement_loops";--> statement-breakpoint
ALTER TABLE "tribe_blueprints" DROP COLUMN "generated_at";--> statement-breakpoint
ALTER TABLE "war_room_sessions" DROP COLUMN "timestamp";