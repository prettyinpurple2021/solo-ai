          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-purple-200 font-mono uppercase text-xs tracking-[0.2em] font-bold">
                Secure Asset Repository System // v1.0.4
              </p>
            </div>
          </div>
        </div>
            ...
            <CyberButton
              ...
              className={
                viewMode === "grid"
                  ...
                  : "border-neon-cyan/30 text-white hover:bg-neon-cyan/10 hover:text-neon-cyan"
              }
            >
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-medium text-white font-orbitron">
                        {folder.name}
                      </h3>
                  ...
                  <div className={viewMode === "grid" ? "p-4" : "p-3"}>
                    {viewMode === "grid" ? (
                      <div className="space-y-3">
                          ...
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <CyberButton
                                variant="ghost"
                                size="sm"
                                className="text-white hover:bg-dark-bg border-none h-8 w-8 p-0"
                              >
                            ...
                            <DropdownMenuContent className="bg-dark-card border-neon-cyan/30 rounded-none">
                              <DropdownMenuItem
                                onClick={() =>
                                  window.open(
                                    `/api/briefcase/files/${doc.id}/download`,
                                    "_blank"
                                  )
                                }
                                className="text-white hover:bg-neon-cyan/10 focus:bg-neon-cyan/10 cursor-pointer font-mono"
                              >
                        ...
                        <div>
                          <h3
                            className="font-medium text-sm truncate text-white font-orbitron"
                            title={doc.name}
                          >
                            {doc.name}
                          </h3>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge className="bg-neon-cyan/10 text-neon-cyan border-neon-cyan/30 rounded-none font-mono">
